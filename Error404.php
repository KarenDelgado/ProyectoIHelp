...
<body>
    ...
    <header>
        ...
        <nav id="site-nav" class="site-nav">
            <ul>
                ...
                <li><a href="Construccion.php"><i class="fa fa-shopping-bag"></i> PRODUCTOS</a></li>
    ...
    <div class="contactoEncabezado">
        ...
        <p class="pMedio">La página esta sufriendo problemas técnicos.<br>Por favor vuelva a intentarlo más tarde o dirijase a Servicios para seguir navegando.</p>
        <div class="intro">
          <img class="envio" src="img/cheems_sad.png">
        </div>
    </div>
